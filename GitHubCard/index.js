...
followersArray.forEach(item =>{
  ...
  .then(response =>{
    ...
    cards.appendChild(cardCreator(user))
...
function cardCreator(gitHub){
  ...
  realName.textContent = gitHub.name;
...
//console.log(cardCreator(gitHub));

axios.get('https://api.github.com/users/Mr-Russell')
.then(response =>{
